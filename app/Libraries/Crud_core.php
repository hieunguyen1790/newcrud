...
class Crud_core
{
    ...
    protected function items_table($columns = null, $items, $pagination)
    {
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a class="btn btn-primary btn-sm" href="' . $this->base . '/crud/' . $this->table . '/add">' . $this->form_title_add . '</a>
                </div>
              </div>
              <!-- /.card-header -->
        ...
        foreach ($items as $item) {
            ...
            $table .= '<td class="text-center"><a href="' . $this->base . '/crud/' . $this->table . '/delete/' . $item->{$primary_key} . '" class="btn btn-danger btn-sm">Delete</a></td><td class="text-center"><a href="' . $this->base . '/crud/' . $this->table . '/edit/' . $item->{$primary_key} . '" class="btn btn-success btn-sm">Edit</a></td>';
            $table .= '</tr>';
        }
    ...
    public function deleteItemstaff($table, $id)
    {
        $key = $this->model->get_primary_key_field_name($table);
        $where = [$key => $id];
        $item = $this->model->getItem($table, $key, $id);
